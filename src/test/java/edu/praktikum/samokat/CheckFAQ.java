...
public class CheckFAQ extends MainTestPattern {
    ...
    public CheckFAQ (String questionParam, String answerParam) {
        this.questionParam = questionParam;
        this.answerParam = answerParam;
    }

    //  Параметры для проверки блока "Вопросы о важном"
    ...
    public void CheckFAQ() {
        ...
        mainPage.checkAnswersText(answerParam); // Проверяем содержание ответа
    }
}
